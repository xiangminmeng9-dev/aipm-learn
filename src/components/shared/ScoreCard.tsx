...
export default function ScoreCard({
  ...
  return (
    <div className="space-y-6">
      <div className={`flex items-center justify-center rounded-2xl border bg-gradient-to-br ${gradientFrom} ${gradientTo} p-8 dark:from-indigo-950/30 dark:to-violet-950/30`}>
...
export { getScoreColor, getBarColor, getBarBg };