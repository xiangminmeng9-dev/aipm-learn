...
const navItems = [
  { label: '面试助手', href: '/interview/assistant', icon: '🤖' },
  ...
  { label: '竞品分析', href: '/interview/competitive', icon: '🔍' },
  { label: '竞品历史', href: '/interview/comp-history', icon: '🕐' },
  { label: '技能树', href: '/skills/tree', icon: (
    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
