  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col border-r border-[#E5E7EB] bg-white">
      <div className="border-b border-[#E5E7EB] px-5 py-5">
        <Link href="/" className="inline-flex items-center gap-1.5 text-base text-[#6B7280] transition-colors hover:text-[#4F46E5]">
          <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
          </svg>
          返回首页
        </Link>
        <h2 className="mt-3 text-xl font-semibold text-[#1F2937]">学习资源库</h2>
      </div>
      ...
      <div className="border-t border-[#E5E7EB] px-5 py-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-base text-[#6B7280]">在线</span>
        </div>
      </div>
    </aside>
  );
