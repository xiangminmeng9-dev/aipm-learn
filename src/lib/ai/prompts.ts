...
评分维度说明：
- 分析深度(0-100)：分析的全面性和深入程度
- 逻辑结构(0-100)：论证的条理性和逻辑自洽性
- 洞察质量(0-100)：洞察的独特性和启发性
- 策略可行性(0-100)：建议的实操性和落地性
- totalScore：四维度加权平均分`;
...
要求：
1. 识别 ${productName} 的 2-3 个主要竞品
2. 从市场定位、功能对比、优劣势分析、差异化策略四个维度进行深入分析
3. 每个维度必须使用指定的 emoji 二级标题（## 🏢 市场定位、## ⚡ 功能对比、## 💪 优劣势分析、## 🎯 差异化策略）
4. 分析应具体、有数据支撑、有独到见解
5. 最后在 \`\`\`json 代码块中给出多维度评分
