...
export async function GET(request: NextRequest) {
  try {
    ...
    const skillAliases: Record<string, string[]> = {
      '大模型应用与落地': ['大模型应用落地', '大模型产品策略', '大模型能力与应用场景', '大语言模型', 'LLM应用', 'LLM', '大模型', 'AI对话与大模型应用落地'],
      'Agent搭建': ['Agent探索与设计', 'Agent架构设计', 'AI Agent搭建', 'AI Agent', 'Agentic产品设计', 'Agent', '智能体', 'AI Agent认知与洞见'],
      '协作能力': ['跨团队协作与项目推进', '跨团队协作', '跨团队协同与资源协调', '沟通与协调能力', '跨部门协作', '团队协作', '沟通能力', '跨团队沟通', '协作能力'],
      '数据驱动': ['数据分析与指标驱动', '数据分析与指标体系搭建', '数据思维与数据驱动决策', '数据驱动与数据分析', '数据分析', '数据驱动决策', '数据思维', '数据敏感度', '数据运营', '数据分析基础'],
      'AI产品设计': ['AI产品', 'AI产品经理', 'AI PM', '人工智能产品', '智能产品', 'AI应用', 'AI智能客服产品设计', 'AI聊天机器人/对话体验设计', 'AI对话产品设计', 'AI技术认知与行业洞察'],
      'Prompt Engineering': ['提示词工程', '提示词设计', 'Prompt设计', 'Prompt优化', '提示词优化', 'Prompt撰写', '提示词编写', 'Prompt工程'],
      '用户研究': ['用户调研', '用户访谈', '用户需求分析', '用户洞察', '用户理解', '用户体验洞察', '用户同理心与价值平衡'],
      'A/B测试': ['AB测试', 'A/B实验', '实验设计', '灰度实验', '分流实验'],
      '产品思维': ['产品意识', '产品sense', '产品感', '产品方法论'],
      '需求分析': ['需求挖掘', '需求梳理', '需求定义', '需求管理', '需求拆解', '需求沟通与管理', '业务需求分析与策略制定'],
      '交互设计': ['用户体验设计', 'UX设计', 'UI/UX', '交互体验', '体验设计', '人机协同体验设计', '人机协同设计'],
      'PRD': ['产品需求文档', '需求文档', 'PRD撰写', 'PRD编写'],
      '项目管理': ['项目推进', '项目协调', '项目落地', '项目交付', '产品实施与推广'],
      '竞品分析': ['竞品研究', '竞品调研', '竞争分析', '竞品对标'],
      'SQL': ['SQL查询', 'SQL分析', '数据库查询'],
      '商业分析': ['商业洞察', '商业模式', '商业sense', '商业理解', '商业化与业务增长驱动', '经营诊断与策略制定'],
      '技术理解': ['技术sense', '技术判断', '技术评估', '技术选型', '技术可行性', 'AI前沿技术跟踪应用'],
      '产品策略': ['产品规划', '产品路线图', '产品方向', '战略规划', '产品0到1建设与迭代规划', '产品全生命周期管理'],
      '指标体系': ['指标搭建', '指标设计', '度量体系', '数据指标'],
      '微调': ['Fine-tuning', '模型微调', 'finetune', '模型训练', '模型微调与训练', 'SFT', 'RL'],
      '多模态': ['多模态模型', '多模态交互', '多模态理解', '跨模态'],
      'API设计': ['接口设计', 'API', 'API规划', '开放平台'],
      'RAG': ['检索增强生成', '检索增强', '知识检索', 'RAG架构'],
      'B端产品': ['B端产品设计', '商家端B端产品建设', '商家后台', 'SaaS系统', '复杂业务中台', '复杂B端系统建设'],
      '行业认知': ['电商行业认知', '生活服务行业认知', '行业业务分析', '行业洞察'],
      '快速学习': ['快速学习与自驱力', '新技术学习与动手实践能力', '自驱力'],
      '平台化建设': ['平台化建设与资产沉淀', '平台化', '资产沉淀'],
      '模型评测': ['模型应用评估与量化分析', '模型训练与评测', 'AI评测', '模型评估'],
    };
